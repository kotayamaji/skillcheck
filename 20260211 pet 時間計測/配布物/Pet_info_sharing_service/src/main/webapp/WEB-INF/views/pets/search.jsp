      ...
      <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
          ...
          <body>
            ...
            <form:form action="/pets/searchResult" modelAttribute="searchForm" method="get">
              <fieldset>
                <div>
                  <label>
                ...
                <div>
                  ...
                  <form:select path="animalTypeId">
                    ...
                    <form:options items="${sessionInfo.animalTypes}" itemLabel="animalTypeName"
                      itemValue="animalTypeId" />
                  </form:select>
                </div>
              </fieldset>
              <form:button>
