...
public class UserDaoImpl implements UserDao {
    ...
    private static final String SELECT_BY_USER_NAME_AND_PASSWORD = "SELECT id, user_name, password, disp_name " +
            "FROM users " +
            "WHERE user_name = :userName AND password = :password ";

    private static final String CATEGORY = " SELECT id animalTypeId , name animalTypeName FROM animal_types ";
    ...
    public List<AnimalType> animalType() {
        List<AnimalType> resultList = jdbcTemplate.query(
                CATEGORY,
