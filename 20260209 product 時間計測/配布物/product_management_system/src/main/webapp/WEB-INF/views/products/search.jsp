      ...
      <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
          ...
          <body>
            ...
            <form:form action="/products/searchResult" modelAttribute="searchForm" method="get">
              <fieldset>
                <div>
                  <label>
                ...
                <div>
                  ...
                  <form:select path="categoryId">
                    ...
                    <form:options items="${sessionInfo.categories}" itemLabel="categoryName" itemValue="categoryId" />
                  </form:select>
                </div>
              </fieldset>
              <form:button>
