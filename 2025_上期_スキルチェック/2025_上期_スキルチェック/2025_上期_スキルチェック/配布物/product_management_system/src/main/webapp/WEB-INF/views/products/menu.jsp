...
<head>
<meta charset="UTF-8">
<title><fmt:message key="title.products.menu" /></title>
...
<body>
  ...
  <h1><fmt:message key="title.products.menu" /></h1>

  <p>
    <a href="/products/search"><fmt:message key="btn.search" /></a>
  </p>
  <p>
    <a href="/products/insert"><fmt:message key="btn.insert" /></a>
  </p>
</body>
</html>
