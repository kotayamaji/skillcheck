      ...
      <%@ taglib uri="http://java.sun.com/jsp/jstl/fmt" prefix="fmt" %>
        <%@ taglib uri="http://www.springframework.org/tags/form" prefix="form" %>
          ...
          <head>
            <meta charset="UTF-8">
            <title>
              <fmt:message key="title.students.register" />
            </title>
          ...
          <body>
            ...
            <form:form action="/students/register" method="post" modelAttribute="registerForm">
              <fieldset class="label-60">
                ...
                <div>
                  ...
                  <form:errors path="hometown" class="error" />
                </div>
                <div>
                  <label>専攻</label>
                  <form:select path="majorId">
                    <form:options items="${sessionInfo.majors}" itemLabel="majorName" itemValue="majorId" />
                  </form:select>
                </div>
              </fieldset>
              <form:button>
