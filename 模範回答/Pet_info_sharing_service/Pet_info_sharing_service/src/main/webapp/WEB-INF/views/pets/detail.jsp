...
<head>
<meta charset="UTF-8">
<title><fmt:message key="title.pets.detail" /></title>
...
<body>
	...
	<fieldset class="label-80">
		<div>
			<label> <fmt:message key="lbl.pet.name" /> <fmt:message
					key="lbl.separator" />
			</label> <span>${fn:escapeXml(pet.name)}</span>
		</div>
		<div>
			<label> <fmt:message key="lbl.animal.type" /> <fmt:message
					key="lbl.separator" />
			</label> <span>${fn:escapeXml(pet.animalTypesName)}</span>
		</div>
		<div>
			<label> <fmt:message key="lbl.description" /> <fmt:message
					key="lbl.separator" />
			</label>
			<pre>${fn:escapeXml(pet.description)}</pre>
		</div>
		<div>
			<label> <fmt:message key="lbl.post.name" /> <fmt:message
					key="lbl.separator" />
			</label> <span>${fn:escapeXml(pet.userName)}</span>
		</div>
	</fieldset>
